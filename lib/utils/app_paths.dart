...
sealed class AppPaths {
  ...
  static Future<void> init() async {
    ...
    var defaultPath = (await getApplicationSupportDirectory()).path;
    var path = storage.getString(_key) ?? defaultPath;
...
Will use the default path $defaultPath.
''', error: e);
      await _setPaths(defaultPath);
    }
  }
