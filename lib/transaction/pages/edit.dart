            ...
            child: DataTable(
              ...
              rows: [
                ...
                if (widget.expense.transaction.bankInfo?.creditorName != null)
                  _fieldRow('Creditor name', widget.expense.transaction.bankInfo!.creditorName!),
                if (widget.expense.transaction.bankInfo?.creditorIban != null)
                  _fieldRow('Creditor IBAN', widget.expense.transaction.bankInfo!.creditorIban!),
                if (widget.expense.transaction.bankInfo?.debtorName != null)
                  _fieldRow('Debtor name', widget.expense.transaction.bankInfo!.debtorName!),
                if (widget.expense.transaction.bankInfo?.debtorIban != null)
                  _fieldRow('Debtor IBAN', widget.expense.transaction.bankInfo!.debtorIban!),
